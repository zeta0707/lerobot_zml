...
def main():
    ...
    # NOTE: It is highly recommended to use the urdf repo: https://github.com/ROBOTIS-GIT/open_manipulator/tree/main/open_manipulator_description/urdf
    ...
    init_rerun(session_name="phone_rebearm_record")
